  ...
  <div>
    <ElDrawer v-model="isDrawerVisible" :size="isMobile ? '100%' : '480px'" :with-header="false">
      <div class="mb-5 flex-cb">
        <div>
          <span class="text-base font-medium">Woj AI Bot</span>
      ...
      <div class="flex h-[calc(100%-70px)] flex-col">
        ...
        <div class="px-4 pt-4">
          ...
          <div class="mt-3 flex-cb">
            <div class="flex-c">
              <SvgIcon icon="ri:image-line" class="mr-5 c-p text-g-600 text-lg" />
              <SvgIcon icon="ri:emotion-happy-line" class="mr-5 c-p text-g-600 text-lg" />
            </div>
